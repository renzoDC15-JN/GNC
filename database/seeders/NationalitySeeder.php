...
class NationalitySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            'Beninese', 'Bermudian', 'Bhutanese', 'Bolivian', 'Botswanan', 'Brazilian',
            ...
            'Comoran', 'Congolese (Congo)', 'Congolese (DRC)', 'Cook Islander',
            ...
            'Ethiopian', 'Faroese', 'Fijian', 'Filipino', 'Finnish', 'French', 'Gabonese',
            'Gambian', 'Georgian', 'German', 'Ghanaian', 'Gibraltarian', 'Greek',
            ...
            'Libyan', 'Liechtenstein citizen', 'Lithuanian', 'Luxembourger', 'Macanese',
            ...
            'Sammarinese', 'Samoan', 'Sao Tomean', 'Saudi Arabian', 'Scottish',
            ...
            'Stateless', 'Sudanese', 'Surinamese', 'Swazi', 'Swedish', 'Swiss'
        ];

        foreach ($data as $index => $d) {
            Nationality::updateOrCreate(['code' => str_pad($index + 1, 3, '0', STR_PAD_LEFT)], ['description' => $d]);
        }
    }
}
