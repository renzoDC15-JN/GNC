...
//        }
        $attribs = [
            ...
            'order' => [
                ...
                'loan_term_in_years' => $row['loan_term_in_years'] ?? 0,
                'loan_term_in_years_in_words' => $row['loan_term_in_years_in_words'] ?? '',
                'retention_fee' => $row['retention_fee'] ?? 0,
                'service_fee' => $row['service_fee'] ?? 0,
                'dslt_total' => $row['dslt_total'] ?? 0,
                'dst' => $row['dst'] ?? '',
