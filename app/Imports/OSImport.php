...
//        }
        $attribs = [
            ...
            'addresses' => [
                ...
                [
                    'type' => 'aif_permanent',
                    'ownership' => Str::title($row['aif_ownership_type'] ?? ''),
                    'full_address' => '',
                    'address1' => Str::title($row['aif_address'] ?? ''),
                    'address2' => Str::title(''),
                    'sublocality' => Str::title($row['aif_barangay'] ?? ''),
                    'locality' => Str::title($row['aif_city'] ?? ''),
                    'administrative_area' => Str::title($row['aif_province'] ?? ''),
                    'postal_code' => Str::title($row['aif_zip_code'] ?? ''),
                    'sorting_code' => '',
                    'country' => 'PH',
                    'block' => Str::title(''),
                    'lot' => Str::title($row['aif_unit_lot'] ?? ''),
                    'unit' => Str::title($row['aif_unit_lot'] ?? ''),
                    'floor' => Str::title(''),
                    'street' => Str::title($row['aif_street'] ?? ''),
                    'building' => Str::title(''),
                ...
                [
                    ...
                    'ownership' => '',
                    'full_address' => '',
                    'address1' => Str::title($row['co_borrower_address'] ?? ''),
                    'address2' => '',
                    'sublocality' => '',
                    'locality' => '',
                    'administrative_area' => '',
            ...
            'employment' => [
                ...
                [
                    'type' => 'aif',
                    'employment_status' => Str::title($row['aif_employment_status'] ?? ''),
                    'monthly_gross_income' => $row['aif_salary_gross_income'] ?? 0,
                    'current_position' => Str::title($row['aif_position'] ?? ''),
                    'employment_type' => Str::title($row['aif_employer_type'] ?? ''),
                    'years_in_service' => Str::title($row['spouse_years_in_service'] ?? ''),
                    'salary_range' => '',
                    'department_name' => '',
                    'character_reference' => [
                    ...
                    'employer' => [
                        'name' => Str::title($row['aif_employer_name'] ?? ''),
                        'industry' => Str::title($row['aif_industry'] ?? ''),
                        'type' => Str::title($row['aif_employer_type'] ?? ''),
                        'status' => Str::title($row['aif_employment_status'] ?? ''),
                        'year_established' => Str::title(''),
                        'total_number_of_employees' => 0,
                        'email' => $row['aif_company_email'] ?? '',
                        'nationality' => 'PH',
                        'contact_no' => (string) ($row['aif_company_phone_number'] ?? ''),
                        'fax' => $row['aif_fax'] ?? '',
                        'address' => [
                            'type' => 'work',
                            'ownership' => 'N/A',
                            'full_address' => Str::title($row['aif_employer_address'] ?? ''),
                            'address1' => Str::title(''),
                            'address2' => Str::title(''),
                            'sublocality' => Str::title(''),
                            'locality' => Str::title(''),
                            'administrative_area' => Str::title(''),
                            'postal_code' => Str::title(''),
                            'sorting_code' => '',
                            'country' => 'PH',
                            'block' => Str::title(''),
                            'lot' => Str::title(''),
                    ...
                    'id' => [
                        'tin' => (string) ($row['aif_tin'] ?? ''),
                        'sss' => (string) ($row['aif_sss'] ?? ''),
                        'pagibig' => (string) ($row['aif_pagibig'] ?? ''),
                        'gsis' => '',
                    ],
                ],
            ...
            'order' => [
                ...
                'disclosure_statement_on_loan_transaction_total' => $row['dslt_total'] ?? 0,
                'documentary_stamp' => $row['dst'] ?? '',
                'total_deductions_from_loan_proceeds' => $row['total_deductions_from_loan_proceeds'] ?? 0,
                'net_loan_proceeds' => $row['net_loan_proceeds'] ?? 0,
                'verified_survey_return_no' => $row['vsr_no'] ?? '',
                ...
                'seller' => [
                    ...
                    'rate' => $row['seller_rate'] ?? '',
                    'rate_amount' => $row['seller_rate_amount'] ?? 0,
                ],
                'payment_scheme' => [
                    ...
                    'fees' => [
                        ...
                        [
                            'name' => 'retention_fee',
                            'amount' => $row['retention_fee'] ?? 0,
                        ],
                        [
                            'name' => 'service_fee',
                            'amount' => $row['service_fee'] ?? 0,
                        ],
                    ],
                ...
                'aif' => [
                    'client_id' => $row['aif_client_id'] ?? '',
                    'account_name' => $row['aif_account_name'] ?? '',
                    'username_or_email' => $row['aif_username_or_email'] ?? '',
                    'profile' => [
                        ...
                        'sex' => $row['aif_gender'] ?? '',
                        'nationality' => $row['aif_nationality'] ?? '',
                        'date_of_birth' => $this->convertExcelDate($row['aif_birthday'] ?? ''),
                        'email' => $row['aif_email'] ?? '',
                        'mobile' => $row['aif_primary_contact_number'] ?? '',
                        'other_mobile' => '',
                        'help_number' => '',
                        'landline' => $row['aif_residence_landline'] ?? '',
                        'mothers_maiden_name' => '',
                        'age' => '',
            ...
            'co_borrowers' => [
                [
                    'profile' => [
                        'first_name' => $row['co_borrower_first_name'] ?? '',
                        'middle_name' => $row['co_borrower_middle_name'] ?? '',
                        'last_name' => $row['co_borrower_last_name'] ?? '',
                        'name_suffix' => $row['co_borrower_name_suffix'] ?? '',
                        'civil_status' => $row['co_borrower_civil_status'] ?? '',
                        'sex' => $row['co_borrower_sex'] ?? '',
                        'nationality' => $row['co_borrower_nationality'] ?? '',
                        'date_of_birth' => $this->convertExcelDate($row['co_borrower_date_of_birth'] ?? ''),
                        'email' =>  '',
                        'mobile' => '',
                        'other_mobile' => '',
                        'help_number' => '',
                        ...
                        'mothers_maiden_name' => '',
                        'age' => '',
                        'relationship_to_buyer' => $row['co_borrower_relationship_to_buyer'] ?? '',
                        'passport' => '',
                        'date_issued' => '',
                        'place_issued' =>  '',
                    ],
                    'spouse' => [
                        'first_name' => $row['co_borrower_spouse_first_name'] ?? '',
                        'middle_name' => $row['co_borrower_spouse_middle_name'] ?? '',
                        'last_name' => $row['co_borrower_spouse_last_name'] ?? '',
                        'name_suffix' => $row['co_borrower_spouse_name_suffix'] ?? '',
                        'civil_status' => $row['co_borrower_civil_status'] ?? '',
                        'sex' => $row['co_borrower_sex'] ?? '',
                        'nationality' => $row['co_borrower_nationality'] ?? '',
                        'date_of_birth' => $this->convertExcelDate($row['co_borrower_date_of_birth'] ?? ''),
                    ...
                    'id' => $row['co_borrower_id'] ?? '',
                    'tin' => $row['co_borrower_tin'] ?? '',
                    'spouse_tin' => $row['co_borrower_spouse_tin'] ?? '',
                ]
            ],
        ];
