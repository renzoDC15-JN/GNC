        ...
        $attribs = [
            ...
            'order' => [
                ...
                'aif' => [
                    ...
                    'birthday' => $this->convertExcelDate($row['aif_birthday'] ?? ''),
                    'age' => $row['aif_age'] ?? '',
                    'gender' => $row['aif_gender'] ?? '',
                    'civil_status' => $row['aif_civil_status'] ?? '',
                    'nationality' => $row['aif_nationality'] ?? '',
                    'residence_landline' => $row['aif_residence_landline'] ?? '',
                    'primary_contact_number' => $row['aif_primary_contact_number'] ?? '',
                    'email' => $row['aif_email'] ?? '',
                    ...
                    'tin' => $row['aif_tin'] ?? '',
                    'sss' => $row['aif_sss'] ?? '',
                    'pagibig' => $row['aif_pagibig'] ?? '',
                    'passport' => $row['aif_passport'] ?? '',
                    'date_issued' => $row['aif_date_issued'] ?? '',
                    'place_issued' => $row['aif_place_issued'] ?? '',
                    'employer_name' => $row['aif_employer_name'] ?? '',
                    'employer_address' => $row['aif_employer_address'] ?? '',
                    'employer_type' => $row['aif_employer_type'] ?? '',
                    'employment_status' => $row['aif_employment_status'] ?? '',
            ...
            'co_borrowers' => [
                [
                    ...
                    'address' => $row['co_borrower_address'] ?? '',
