...
//        }
        $attribs = [
            ...
            'order' => [
                ...
                'amort_mrisri2' => $row['amort_mrisri2'] ?? 0,
                'amort_mrisri3' => $row['amort_mrisri3'] ?? 0,
                'amort_nonlife1' => $row['amort_nonlife1'] ?? 0,
                'amort_nonlife2' => $row['amort_nonlife2'] ?? 0,
                'amort_nonlife3' => $row['amort_nonlife3'] ?? 0,
                'amort_princ_int1' => $row['amort_princ_int1'] ?? 0,
                'amort_princ_int2' => $row['amort_princ_int2'] ?? 0,
                'amort_princ_int3' => $row['amort_princ_int3'] ?? 0,
