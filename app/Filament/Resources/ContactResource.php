...
//                                                $this->data['order']['technical_description'] = $response->json()['Technical Description'];
                        ...
                        Forms\Components\Fieldset::make('aif')
                        ...
                        ->schema([
                            Forms\Components\Fieldset::make('Personal Information')->schema([
                                ...
                                Forms\Components\TextInput::make('aif.profile.other_mobile')
                                    ->label('Other Mobile')
                                    ->prefix('+63')
                                    ->regex("/^[0-9]+$/")
                                    ->minLength(10)
                                ...
                                Forms\Components\TextInput::make('aif.profile.landline')
                                    ->label('Landline')
                                    ->columnSpan(3),
                            ])->columns(12)->columnSpanFull(),
                            Forms\Components\Fieldset::make('Address')->schema([
                                ...
                                Forms\Components\TextInput::make('aif.present.block')
                                    ->label('Block')
                                    ->columnSpan(3),

                                Forms\Components\TextInput::make('aif.present.street')
                                    ->label('Street')
                                    ->columnSpan(3),
                                Forms\Components\TextInput::make('aif.present.country')
                                    ->label('Country')
                                    ->columnSpan(3),
                                Forms\Components\TextInput::make('aif.present.region')
                                    ->label('Region')
                                    ->columnSpan(3),
                            ])->columns(12)->columnSpanFull(),
                            Forms\Components\Fieldset::make('Employment Information')
                                ->schema([
                                    ...
                                    Forms\Components\TextInput::make('aif.employment.current_position')
                                        ->label('Current Position')
                                        ->columnSpan(3),

                                    Forms\Components\TextInput::make('aif.employment.rank')
                                        ->label('Rank')
                                        ->columnSpan(3),
                                    ...
                                    Forms\Components\TextInput::make('aif.employment.salary_range')
                                        ->label('Salary Range')
                                        ->columnSpan(3),
                                    Forms\Components\TextInput::make('aif.employment.id.tin')
                                        ->label('TIN')
                                        ->columnSpan(3),

                                    Forms\Components\TextInput::make('aif.employment.id.pagibig')
                                        ->label('Pag-IBIG')
                                        ->columnSpan(3),

                                    Forms\Components\TextInput::make('aif.employment.id.sss')
                                        ->label('SSS')
                                        ->columnSpan(3),

                                    Forms\Components\TextInput::make('aif.employment.id.gsis')
                                        ->label('GSIS')
                                        ->columnSpan(3),
                                    Forms\Components\TextInput::make('aif.employment.character_reference.name')
                                        ->label('Character Reference Name')
                                        ->columnSpan(3),

                                    Forms\Components\TextInput::make('aif.employment.character_reference.mobile')
                                        ->label('Character Reference Mobile')
                                        ->columnSpan(3),
                                ])->columns(12)->columnSpanFull(),
                            Forms\Components\Fieldset::make('Employer Information')->schema([
                                ...
                                Forms\Components\TextInput::make('aif.employment.employer.year_established')
                                    ->label('Year Established')
                                    ->columnSpan(3),

                                Forms\Components\TextInput::make('aif.employment.employer.total_number_of_employees')
                                    ->label('Total Number of Employees')
                                    ->numeric()
                                    ->columnSpan(3),

                                Forms\Components\TextInput::make('aif.employment.employer.email')
                                    ->label('Employer Email')
                                    ->email()
                                    ->columnSpan(3),

                                Forms\Components\TextInput::make('aif.employment.employer.fax')
                                    ->label('Employer Fax')
                                    ->columnSpan(3),
                                Forms\Components\TextInput::make('aif.employment.employer.address.full_address')
                                    ->label('Full Address')
                                    ->columnSpan(6),

                                Forms\Components\TextInput::make('aif.employment.employer.address.locality')
                                    ->label('City')
                                    ->columnSpan(3),

                                Forms\Components\TextInput::make('aif.employment.employer.address.administrative_area')
                                    ->label('Province')
                                    ->columnSpan(3),
